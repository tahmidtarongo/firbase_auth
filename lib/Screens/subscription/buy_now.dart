...
class _BuyNowState extends State<BuyNow> {
  ...
  SubscriptionRequestModel data = SubscriptionRequestModel(subscriptionName: '', transactionNumber: '', note: '', attachment: '', userId: constUserId);
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    data.subscriptionName = widget.subscriptionPlanModel.subscriptionName;
  }
...
class SubscriptionRequestModel {
  late String subscriptionName, transactionNumber, note, attachment, userId;

  SubscriptionRequestModel({required this.subscriptionName, required this.transactionNumber, required this.note, required this.attachment, required this.userId});
