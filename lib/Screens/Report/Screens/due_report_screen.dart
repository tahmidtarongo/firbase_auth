                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: ListTile(
                                      ...
                                      subtitle: Text(
                                          'Total Due ${isPicked ? '(From ${fromDate.toString().substring(0, 10)} to ${toDate.toString().substring(0, 10)})' : '(This Month)'}'),
                                    ),
                                  ),
                                ),
                              ),
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Text(
                                                            ...
                                                            style:
                                                                TextStyle(color: reTransaction[index].dueAmountAfterPay! <= 0 ? const Color(0xff0dbf7d) : const Color(0xFFED1A3B)),
                                                          ),
                                                        ),
                                                        Column(
