    ...
    return Consumer(builder: (_, ref, watch) {
      ...
      return userProfileDetails.when(data: (user) {
        return Scaffold(
          ...
          appBar: user.verificationStatus == 'pending'? AppBar(
            backgroundColor: kMainColor,
            title: Text(
              'KYC Verification',
          ...
          body: Container(
            ...
            child: RefreshIndicator(
              ...
              child: SingleChildScrollView(
                ...
                child: user.verificationStatus == 'pending'? Padding(
                  ...
                  children: [
                    ...
                    ).onTap(() => SmsPlanScreen(smsBalance: user.smsBalance.toString(),).launch(context)),
                  ],
                ),
              ),
            ),
