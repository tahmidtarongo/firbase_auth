                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: TabBarView(children: [
                      history.isEmpty ? const Center(child: Text('No History Found!',style: TextStyle(color: Colors.black,fontSize: 18.0,fontWeight: FontWeight.w700),),) : ListView.builder(
                      ...
                      transactionList.when(data: (transaction){ return ListView.builder(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    Text('Transaction Id: ${transaction[i].transactionId}',style: const TextStyle(color: kGreyTextColor,),textAlign: TextAlign.start),
                                                  ],
                                                ),
                                                const SizedBox(
                                                  height: 10.0,
