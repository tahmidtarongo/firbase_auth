...
class _ProductListState extends State<ProductList> {
  ...
  Widget build(BuildContext context) {
    return Consumer(builder: (context, ref, __) {
      ...
      return categoryData.when(data: (category) {
        if(count == 0){
          category.insert(0, CategoryModel(categoryName: 'All', size: false, color: false, capacity: false, type: false, weight: false,));
          count++;
        }
                      ...
                      return products.isNotEmpty
                          ? ListView.builder(
                              ...
                              itemBuilder: (_, i) {
                                ...
                                ).visible(categoryName == 'All' ? true : products[i].productCategory == categoryName);
                              })
                          : const Center(
                              child: Padding(
