...
//   Future<void> editData({required ProfileModel studentModel}) async {
...
//     classController.text = widget.studentModel.address.toString();
//     rollController.text = widget.studentModel.phoneNumber.toString();
//     sectionController.text = widget.studentModel.landMark ?? '';
//   }
//
//   @override
//   void dispose() {
...
//                     address: int.tryParse(classController.text) ?? 0,
//                     phoneNumber: int.tryParse(rollController.text) ?? 0,
//                     landMark: sectionController.text);
//
