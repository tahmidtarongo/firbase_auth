...
Future<File> createAndSaveSalePDF({required TransitionModel transactions, required PersonalInformationModel personalInformation, required BuildContext context}) async {
  ...
  final file = File('${output.path}/smart_biashara_sale_${transactions.invoiceNumber}.pdf');
  await file.writeAsBytes(await pdf.save());

  return file;
}

void shareSalePDF({required TransitionModel transactions, required PersonalInformationModel personalInformation, required BuildContext context}) async {
