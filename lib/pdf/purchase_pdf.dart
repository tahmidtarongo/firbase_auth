...
Future<File> createAndSaveSalePDF({required PurchaseTransitionModel transactions, required PersonalInformationModel personalInformation, required BuildContext context}) async {
  ...
  final file = File('${output.path}/smart_biashara_purchase_${transactions.invoiceNumber}.pdf');
  await file.writeAsBytes(await pdf.save());

  return file;
}

void sharePurchasePDF({required PurchaseTransitionModel transactions, required PersonalInformationModel personalInformation, required BuildContext context}) async {
