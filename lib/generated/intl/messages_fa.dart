...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "featureAreTheImportant": MessageLookupByLibrary.simpleMessage(
            "ویژگی‌ها بخش مهمی هستند که Smart Biashara را از راه‌حل‌های سنتی متمایز می‌کند."),
        ...
        "mobiPosAppIsFree": MessageLookupByLibrary.simpleMessage(
            "برنامه Smart Biashara رایگان و آسان در استفاده است. در واقع، این یکی از بهترین سیستم‌های POS در سراسر دنیاست."),
        "mobiPosIsaCompleteBusinesSolution": MessageLookupByLibrary.simpleMessage(
            "Smart Biashara یک راهکار کامل کسب و کار با مدیریت موجودی، حسابداری، فروش، هزینه و سود/زیان است."),
        ...
        "powerdedByMobiPos": MessageLookupByLibrary.simpleMessage(
            "توسط Smart Biashara تامین می‌شود"),
        ...
        "useMobiPos":
            MessageLookupByLibrary.simpleMessage("استفاده از Smart Biashara"),
        ...
        "youHaveSuccefulyLogin": MessageLookupByLibrary.simpleMessage(
            "شما با موفقیت وارد حساب کاربری خود شده‌اید. با Smart Biashara همراه باشید."),
