...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "featureAreTheImportant": MessageLookupByLibrary.simpleMessage(
            "機能は、Smart Biasharaを従来のソリューションとは異なるものにする重要な部分です。"),
        ...
        "mobiPosAppIsFree": MessageLookupByLibrary.simpleMessage(
            "Smart Biasharaアプリは無料で、使いやすいです。実際、これは世界中で最も優れたPOSシステムの1つです。"),
        "mobiPosIsaCompleteBusinesSolution":
            MessageLookupByLibrary.simpleMessage(
                "Smart Biasharaは在庫、アカウント、販売、支出、損益を含む完全なビジネスソリューションです。"),
        ...
        "useMobiPos":
            MessageLookupByLibrary.simpleMessage("Smart Biasharaを使用する"),
        ...
        "youHaveSuccefulyLogin": MessageLookupByLibrary.simpleMessage(
            "アカウントに正常にログインしました。Smart Biashara をご利用ください。"),
